...
config = [{'classifier_str' : 'knn', 'n_neighbors' : 3, 'gs_n_jobs' : 8},
          {'classifier_str' : 'knn', 'n_neighbors' : 5, 'gs_n_jobs' : 8},
          {'classifier_str' : 'knn', 'n_neighbors' : 7, 'gs_n_jobs' : 8}]
...
if (count_gt[0] != count_gt[1]):
    ...
    data_folder = '/work/le2i/gu5306le/retinopathy/OCT/SERI/feature_data/flatten_aligned_cropped/lbp_riu/lbp_hist/lbp_global/r_' + str(radius) + '_hist_npz'
    codebook_filename = '/work/le2i/gu5306le/retinopathy/OCT/SERI/feature_data/flatten_aligned_cropped/lbp_riu/lbp_hist/lbp_global/r_' + str(radius) + '_hist_npz/codebook_random/codebook.pkl'
    ...
    path_to_save = '/work/le2i/gu5306le/retinopathy/OCT/SERI/results/flatten_aligned_cropped/lbp_riu/lbp_global/r_' + str(radius) + '_bow_random'
