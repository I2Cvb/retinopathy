...
if (count_gt[0] != count_gt[1]):
    ...
    # unflatten codebook
    #codebook_filename = '/work/le2i/gu5306le/OCT/lbp_nri_non_flatten_r_' + str(radius) + '_hist_codebook/codebook.pkl'
    # flatten codebook
    codebook_filename = '/work/le2i/gu5306le/OCT/lbp_nri_flatten_r_' + str(radius) + '_hist_codebook_random/codebook.pkl'
    ...
    # unflatten saving
    #path_to_save = '/work/le2i/gu5306le/OCT/SPIE/lbp_nri_non_flatten_r_' + str(radius) + '_hist_BoW_now_results'
    # flatten saving
    path_to_save = '/work/le2i/gu5306le/OCT/SPIE/lbp_nri_flatten_r_' + str(radius) + '_hist_BoW_now_results'
