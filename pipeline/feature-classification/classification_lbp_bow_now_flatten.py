...
if (count_gt[0] != count_gt[1]):
    ...
    codebook_filename = '/work/le2i/gu5306le/retinopathy/OCT/SERI/feature_data/flatten/lbp_riu/lbp_hist/lbp_local/r_' + str(radius) + '_hist_npz/codebook_random/codebook.pkl'
    ...
    path_to_save = '/work/le2i/gu5306le/retinopathy/OCT/SERI/results/flatten/lbp_riu/lbp_local/r_' + str(radius) + '_bow_knn'
