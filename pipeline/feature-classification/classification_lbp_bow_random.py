...
if (count_gt[0] != count_gt[1]):
    ...
    codebook_filename = '/work/le2i/gu5306le/OCT/lbp_r_' + str(radius) + '_hist_now_codebook_random_1/codebook.pkl'
    ...
    results_by_codebook = Parallel(n_jobs=60)(delayed(ParallelClassification)(idx_test, (pat_test_norm, pat_test_dme), filename_normal, filename_dme, data_folder) for idx_test, (pat_test_norm, pat_test_dme) in enumerate(zip(filename_normal, filename_dme)))

    # We have to store the final codebook
    path_to_save = '/work/le2i/gu5306le/OCT/lbp_r_' + str(radius) + '_hist_BoW_random_results_set_2'
