...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for mId = 3 : 3 
        for nId  = 1 : length(ntree)
            for WId = 1 : length(numWords)
                  
                pred_label =  zeros(32,1); 
...
%                        end 
                    ...
                    TrainModel = classRF_train(train_data, train_label, ntree(nId)); 
        ...
        save(fullfile(path_to_save, [mapsname(mId, 1:mapsL(mId)) '_' '32_100_result.mat']), 'Acc', 'TPR', 'TNR', 'PRE'); 
    end 
